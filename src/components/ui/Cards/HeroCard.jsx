...
const HeroCard = () => {
  return (
    <div className="absolute top-[50%] -translate-y-[50%] sm:left-[10%] 2xl:left-[15%] bg-neutral-900/90 h-96 w-11/12 sm:w-96 p-6 rounded-lg flex flex-col gap-3 items-center justify-between">
